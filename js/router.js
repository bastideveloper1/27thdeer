        ...
        setTimeout(() => {
            ...
            const checkBootstrap = () => {
                if (typeof bootstrap !== 'undefined') {
                    // Limpiar modales existentes del body
                    const existingModals = document.body.querySelectorAll('.modal');
                    existingModals.forEach(modal => modal.remove());
                    
                    // Limpiar backdrops existentes
                    const existingBackdrops = document.body.querySelectorAll('.modal-backdrop');
                    existingBackdrops.forEach(backdrop => backdrop.remove());
                    
                    // Remover clases modal del body
                    ...
                    if (window.location.pathname.includes('proyectos')) {
                        ...
                        `;
                        // Agregar directamente al body, no al main
                        document.body.insertAdjacentHTML('beforeend', modalHTML);
                        
                        // Esperar un poco más y luego inicializar el modal
                        setTimeout(() => {
                    ...
                    // Si Bootstrap no está disponible, reintentar
